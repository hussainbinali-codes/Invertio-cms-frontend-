      ...
      <Card className="w-full max-w-md shadow-2xl animate-in fade-in zoom-in duration-200">
        <CardHeader className="flex flex-row items-center justify-between py-6 border-b border-slate-50">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">Changing {employeeName}'s payroll ({period}) to <span className="font-bold text-primary-600">{targetStatus}</span></p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Button
                ...
                onClick={() => document.getElementById('payroll-proof-input').click()}
              >
